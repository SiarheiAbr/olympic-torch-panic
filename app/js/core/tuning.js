  ...
  [
    {
      ...
      weights: { WIND_GUST: 50, RAIN_SHOWER: 30, DRONE_DOWNDRAFT: 0, BEACH_BALL: 20, FIREWORKS_BURST: 0 },
    },
    {
      name: 'Storm Coast',
      ...
      weights: { WIND_GUST: 30, RAIN_SHOWER: 40, DRONE_DOWNDRAFT: 20, BEACH_BALL: 10, FIREWORKS_BURST: 0 },
    },
    {
      name: 'Desert Highway',
      maxConcurrentHazards: 2,
      ...
      weights: { WIND_GUST: 35, RAIN_SHOWER: 0, DRONE_DOWNDRAFT: 30, BEACH_BALL: 20, FIREWORKS_BURST: 15 },
    },
    {
      ...
      weights: { WIND_GUST: 20, RAIN_SHOWER: 15, DRONE_DOWNDRAFT: 20, BEACH_BALL: 30, FIREWORKS_BURST: 15 },
    },
    {
      name: 'Downtown LA',
      maxConcurrentHazards: 3,
      ...
      weights: { WIND_GUST: 20, RAIN_SHOWER: 10, DRONE_DOWNDRAFT: 25, BEACH_BALL: 15, FIREWORKS_BURST: 30 },
    },
  ].map((env, i) =>
    Object.freeze({
      ...env,
